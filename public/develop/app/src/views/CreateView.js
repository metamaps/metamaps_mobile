define(function(require, exports, module) {
    ...
    function _createInput() {
        ...
        this.inputMod.sizeFrom(function() {
            return [window.innerWidth - 32, 80];
        });
    ...
    function _createImageCapture() {
        ...
        this.imageCapMod.sizeFrom(function() {
            return [window.innerWidth - 32, 150];
        });
    ...
    function _createRecorder() {
        ...
        this.recordMod.sizeFrom(function() {
        ...
        this.recordSurface.on('touchstart', function(e) {
            ...
            this.recordSurface.setProperties({
                backgroundColor: '#81D381'
            });
    ...
    function _createStrips() {
        ...
        metacodes = _.sortBy(metacodes, function(metacode) {
            return metacode.get('name').toLowerCase();
        });
        ...
        for (var col = 0; col < metacodes.length; col++) {
            ...
            var imageUrl = metacode.get('icon').indexOf('http://') !== -1 || metacode.get('icon').indexOf('https://') !== -1 ? metacode.get('icon') : 'content/images' + metacode.get('icon');
        ...
        var wildcard = _.find(metacodes, function(metacode) {
            return metacode.get('name') === 'Wildcard';
        });
    ...
    CreateView.prototype.previewFile = function(ev) {
        ...
        if (file.type.indexOf("image") == 0) {
            reader.onload = function(e) {
                ...
                this.imagePreview.setContent('<img src="' + e.target.result + '" width="' + (window.innerWidth - 32) + '" />');
            }.bind(this)
